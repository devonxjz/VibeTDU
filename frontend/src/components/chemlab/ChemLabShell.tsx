    ...
    <>
      <div className="flex h-screen w-screen flex-col overflow-hidden bg-clay-canvas text-clay-ink">
        ...
        <div className="flex min-h-0 flex-1 gap-3 px-3 pb-3 md:px-4 md:pb-4">
          <div
            ref={leftColRef}
            className="hidden shrink-0 overflow-hidden rounded-[28px] border border-clay-hairline bg-clay-surface-soft lg:flex"
          ...
          >
            ...
            <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col gap-1 rounded-full border border-clay-hairline bg-clay-surface-card px-1.5 py-2">
              {[0, 1, 2, 3].map((dot) => (
          ...
          <div className="min-w-0 flex-1">
            <div className="relative flex h-full min-w-0 flex-col overflow-hidden rounded-[32px] border border-clay-hairline bg-clay-surface-soft">
              <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-white/40 to-transparent dark:from-white/4" />
          ...
          <div className="hidden w-[360px] shrink-0 overflow-hidden rounded-[28px] border border-clay-hairline bg-clay-surface-soft md:flex">
            <ChemicalLibrary />
          </div>
        </div>
      </div>
