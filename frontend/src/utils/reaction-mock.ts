  ...
  switch (key) {
    case "hcl+naoh":
      return {
        ...
        effectType: "HEAT",
        effectColor: "rgba(255, 100, 50, 0.4)",
        messageVi: "Dung dịch trở nên trong suốt và tỏa nhiệt mạnh. Đây là phản ứng trung hòa.",
        explanationVi: "Axit mạnh (HCl) tác dụng với bazơ mạnh (NaOH) tạo thành muối (NaCl) tan và nước, tỏa nhiều nhiệt.",
        safetyNoteVi: "Phản ứng tỏa nhiệt, cẩn thận khi chạm vào cốc.",
